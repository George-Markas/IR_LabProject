...
- Term Frequency (TF) -- πόσο συχνά εμφανίζεται ένας όρος στο έγγραφο:
#align(center)[
    #set text(size: 16pt)
...
Λειτουργεί υπολογίζοντας την ομοιότητα μεταξύ ενός query $q$ και ενός εγγράφου $d$,
χρησιμοποιώντας Term Frequency (TF), Inverse Document Frequency (IDF) και
Document Length Normalization (κανονικοποιεί την ομοιότητα για μεγαλύτερα
